...
<div class="min-h-screen flex items-center justify-center pt-24 px-4">
    <div class="w-full max-w-lg bg-white rounded-xl shadow-2xl p-8">
        ...
        <form method="POST" action="{{ route('comercios.store') }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div>
                <label class="block mb-2 text-sm font-medium text-gray-900">Foto del Comercio</label>
            ...
            <div class="flex gap-4 pt-4">
                ...
                <button type="submit"
                    class="w-1/2 text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 transition">Guardar</button>
            </div>
        </form>
    </div>
</div>
