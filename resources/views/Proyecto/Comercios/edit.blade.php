            ...
            <form method="POST" action="{{ route('comercios.update', $comercio->id_comercio) }}" class="space-y-4">
                ...
                <div class="flex items-center">
                    <input id="activo" name="activo" type="checkbox" value="1"
                        {{ $comercio->activo == 1 ? 'checked' : '' }} class="w-4 h-4 border-gray-300 rounded">
                ...
                <div class="flex gap-4 pt-2">
                    ...
                    <button type="submit"
                        class="w-1/2 text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5">Actualizar</button>
                </div>
