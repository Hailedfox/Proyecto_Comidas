...
<div class="min-h-screen flex flex-col items-center justify-center py-12 px-4 bg-gray-900 bg-blend-overlay bg-cover bg-center bg-no-repeat fondo-ondas-animado relative"
    ...
    <div class="relative z-10 w-full flex flex-col items-center animate-fade-in pt-16">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-300 text-sm mt-2">Accede a tu panel de administración</p>
        </div>
        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div class="p-8">
                ...
                <form method="POST" action="/login" class="space-y-5">
                    ...
                    <button type="submit"
                        class="w-full text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm px-5 py-3 text-center transition-all transform hover:scale-[1.02] shadow-md">
                        Ingresar
                    </button>
                </form>
                ...
                <a href="{{ route('google.login') }}" 
                   class="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 font-medium py-2.5 px-4 rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
            ...
            <div class="bg-gray-50 px-8 py-4 text-center border-t border-gray-100">
                <p class="text-sm text-gray-600">
                    ¿No tienes cuenta? 
                    <a href="{{ route('usuarios.create') }}" class="text-blue-600 hover:text-blue-800 font-bold hover:underline">
                        Regístrate aquí
                    </a>
                </p>
            </div>
